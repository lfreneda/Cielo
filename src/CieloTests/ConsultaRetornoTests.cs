...
{
    [TestFixture]
    public class ConsultaRetornoTests
    {
        ...
        [Test]
        public void GivenAReponseXml_CanGetStatus() {
            var retorno = new ConsultaRetorno(ExpectedResponseXml);
            retorno.Status.Should().Be(Status.Criada);
        }
    }
}